...
extern "C" {
	...
	pp.query("phi_min", CNS::h_prob_parm->phi_min);
	pp.query("phi_max", CNS::h_prob_parm->phi_max);

	pp.query("penalty_slope", CNS::h_prob_parm->penalty_slope);
        pp.query("oxidizer_threshold",CNS::h_prob_parm->oxidizer_threshold);
